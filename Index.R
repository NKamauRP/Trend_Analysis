...
barplot(Overall_SRI_Scores_Dataset$`Count 2`,
        main = 'Count 2 Overall Score',
        xlab = 'frequency', horiz = TRUE)

barplot(Overall_SRI_Scores_Dataset$`Count 3`,
        main = 'Count 3 Overall Score',
        xlab = 'frequency', horiz = TRUE)

barplot(Overall_SRI_Scores_Dataset$`Count 4`,
        main = 'Count 4 Overall Score',
        xlab = 'frequency', horiz = TRUE)

barplot(Overall_SRI_Scores_Dataset$`Count 5`,
        main = 'Count 5 Overall Score',
        xlab = 'frequency', horiz = TRUE)
# box plot
